const en = {
  ...
  shell: {
    ...
    promoCodeLabel: "Code",
    promoCodeCopy: "Copy code {code}",
    promoCodeHint: "Copy this code",
    promoCodeCopied: "Copied! Enjoy {discount}% off",
  ...
  studio: {
    ...
    errors: {
      ...
      referenceUpload: "A reference image could not be uploaded. Please try again.",
