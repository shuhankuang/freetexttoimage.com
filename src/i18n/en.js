const en = {
  ...
  pricing: {
    ...
    subtitle: "Subscribe for monthly credits, or top up anytime. Permanent credits never expire.",
    subscriptionSection: "Monthly plans",
    onetimeSection: "One-time top-ups",
    perMonth: "/mo",
    plans: { basic: { label: "Basic" }, pro: { label: "Pro" } },
    planCredits: "{count} credits / month",
