const en = {
  ...
  auth: {
    ...
    join: "Join Forma",
    signInBody: "Sign in to open your image workspace.",
    signUpBody: "Create your account to start creating.",
    name: "Name",
    ...
    legal: "Your account and creations are stored securely. Passwords are hashed and never shared.",
    errors: {
