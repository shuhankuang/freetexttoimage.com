...
const copy = {
  en: {
    subject: `Your sign-in link for ${BRAND_NAME}`,
    eyebrow: "SECURE SIGN-IN",
    title: `Open your ${BRAND_NAME} workspace`,
    body: "Use the button below to sign in or create your account. This link expires in 15 minutes and can only be used once.",
    button: `Sign in to ${BRAND_NAME}`,
    ignore: "If you didn’t request this email, you can safely ignore it.",
    text: `Use this link to sign in to ${BRAND_NAME}. It expires in 15 minutes and can only be used once:`,
  },
  ja: {
    subject: `${BRAND_NAME}へのログインリンク`,
    eyebrow: "安全なログイン",
    title: `${BRAND_NAME}ワークスペースを開く`,
    body: "下のボタンからログイン、またはアカウントを作成できます。このリンクは15分後に期限切れとなり、一度だけ使用できます。",
    button: `${BRAND_NAME}にログイン`,
    ignore: "このメールに心当たりがない場合は、そのまま破棄してください。",
    text: `次のリンクから${BRAND_NAME}にログインしてください。リンクは15分後に期限切れとなり、一度だけ使用できます：`,
  },
};
